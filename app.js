            ...
            <div class="bill-modal-foot">
                ...
                <div class="bill-modal-section">
                    ...
                    <div class="bill-doc-links">
                        ...
                        ${bill.committeeReportUrl ? `<a href="${bill.committeeReportUrl}" class="bill-modal-link ${procedureClass}" target="_blank" rel="noopener" title="${bill.committeeReportCitation || 'Committee Report'}">Committee Report →</a>` : ''}
